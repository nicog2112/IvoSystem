                        ...
                        <tbody id="detalle_productos">
                            ...
                            <?php foreach($lista as $venta){ ?>
                                <?php foreach($listaDetallesFactura as $detalleVenta){ ?>
                                    <tr>
                                        <td class="textcenter"><?php echo $detalleVenta->getCantidad(); ?></td>
                                        <td><img src='../../modulos/productos/<?php echo $detalleVenta->productoTalle->producto->getImagen(); ?>'style="max-width:100px;width:70px;height:100px;"> </td>
                                        <td><?php echo $detalleVenta->productoTalle->producto->getDescripcion(); ?></td>
                                 
                                        <td class="textright">$<?php echo $detalleVenta->getPrecio(); ?></td>
                                        <?php 
