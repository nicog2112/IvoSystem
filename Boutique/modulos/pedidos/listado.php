...
$lista = Venta::obtenerTodosPendientes($filtroEstado);
...
<?php foreach ($listadoModulos as $modulo5): ?>
  ...
  ?>
                     <a href="/programacion_3/boutique/modulos/reportes/reportePedidos.php" class="botonAñadir"  ><i class="fas fa-chart-line"></i> Reportes </a>
      ...
      <?php endforeach ?>
                ...
                <table id="tabla5" class="styled-table" >
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Fecha</th>
                ...
                <table style="margin: auto; width: 100%;text-align: center;">
                    <thead>
                        <tr>
                            ...
                            <th><i class="botonActualizar fas fa-file-invoice-dollar" title="Generar Factura"></i></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="100px">Generar Factura</td>
