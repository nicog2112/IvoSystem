...
<form method="POST" action="procesar_modificacion.php"  enctype="multipart/form-data" class="form__reg" name="formulario" id="formularioModificar" novalidate>
	...
	<div id="parte1Modificar" style="display:block;">
		...
		<div class="formulario__grupo" id="grupo__nombrePersonaModificar">
			...
			<div class="formulario__grupo-input">
				<input type="text" class="formulario__input" name="nombrePersonaModificar" id="nombrePersonaModificar" value="<?php echo $persona->getNombre(); ?>">
		...
		<div class="formulario__grupo" id="grupo__apellidoPersonaModificar">
			...
			<div class="formulario__grupo-input">
				<input type="text" class="formulario__input" name="apellidoPersonaModificar" id="apellidoPersonaModificar"  value="<?php echo $persona->getApellido(); ?>" >
				<i class="formulario__validacion-estado fas fa-times-circle"></i>
			</div>
	...
	<div id="parte2Modificar" style="display:none;">
		...
		<div class="formulario__grupo" id="grupo__dniPersonaModificar">
			...
			<div class="formulario__grupo-input">
				<input type="number" class="formulario__input" name="dniPersonaModificar" id="dniPersonaModificar"  value="<?php echo $persona->getDni(); ?>" >
				<i class="formulario__validacion-estado fas fa-times-circle"></i>
			</div>
		...
		<div class="formulario__grupo" id="grupo__fechaNacimientoPersonaModificar">
			...
			<div class="formulario__grupo-input">
				<input type="date" class="formulario__input" name="fechaNacimientoPersonaModificar" id="fechaNacimientoPersonaModificar"  value="<?php echo $persona->getFechaNacimiento(); ?>">
				<i class="formulario__validacion-estado fas fa-times-circle"></i>
			</div>
	...
	<div id="parte3Modificar" style="display:none;">
			...
			<div class="formulario__grupo-input">
				<select name="sexoPersonaModificar" id="sexoPersonaModificar" class="formulario__input">
					...
					<?php foreach ($listadoSexo as $sexo): ?>
						...
						if ($sexo->getIdSexo() == $persona->getIdSexo()) {
							$selected = "SELECTED";
						}
		...
		<div class="formulario__grupo" id="grupo__nacionalidadPersonaModificar">
			...
			<div class="formulario__grupo-input">
				<input type="text" class="formulario__input" name="nacionalidadPersonaModificar" id="nacionalidadPersonaModificar"  value="<?php echo $persona->getNacionalidad(); ?>">
				<i class="formulario__validacion-estado fas fa-times-circle"></i>
			</div>
