...
$lista = Persona::obtenerTodosPersonas($filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    switch ($_GET["error"]) {
      ...
      case 'dniExistente':
        $mensaje = "<div class='error'>"."El dni que desea registrar ya existe en el sistema"."</div>";
        break;
...
<head>
    ...
    <script type="text/javascript">
        ...
        function HabilitarLegajo(check){ 
            var input = document.getElementById("grupo__legajoNuevo"); 
                ...
                <tbody>
                    <?php foreach  ($lista as $persona): ?>
                        <tr class="active-row">
                            ...
                            <td><?php echo $persona->getDni(); ?></td>
                            <td><?php echo $persona->sexo->getDescripcion(); ?></td>
                            <?php
                            ...
                            <td> <a href="../persona/detalle.php?id_persona=<?php echo $persona->getIdPersona();?>"><i class="botonGeneral fas fa-plus"></i> </a></td>
                           
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $persona->getIdPersona(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>

                              <?php if($persona->getIdPersona() > 1){ ?>
                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $persona->getIdPersona(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                            <?php } else{ ?>
            ...
            <div class="flex" id="flex4">
                <div class="contenido-modal">
                    ...
                    <div class="modal-body" id="modal-body2">
                        ...
                        <button type="cancel" name="Cancelar" class="botonCancelar"  onclick="window.location='/programacion_3/boutique/modulos/persona/listado.php';return false;">Cancelar</button>
