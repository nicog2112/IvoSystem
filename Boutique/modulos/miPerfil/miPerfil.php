...
<form method="POST" action="../../modulos/miPerfil/procesar_modificacion.php"  enctype="multipart/form-data" class="form__reg" name="formulario" id="formularioMiPerfil">
    ...
    <div id="parte1" style="display:block;">
        ...
        <div class="formulario__grupo" id="grupo__nombreUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="nombreUsuario" id="nombreUsuario" value="<?php echo $usuario->getNombre(); ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
        ...
        <div class="formulario__grupo" id="grupo__apellidoUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="apellidoUsuario" id="apellidoUsuario" value="<?php echo $usuario->getApellido(); ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
    ...
    <div id="parte2" style="display:none;">
        ...
        <div class="formulario__grupo" id="grupo__dniUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="number" class="formulario__input" name="dniUsuario" id="dniUsuario" value="<?php echo $usuario->getDni(); ?>" >
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
        ...
        <div class="formulario__grupo" id="grupo__nacionalidadUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="text" class="formulario__input" name="nacionalidadUsuario" id="nacionalidadUsuario" value="<?php echo $usuario->getNacionalidad(); ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
            <br>
            <p class="formulario__input-error">El nombre tiene que ser de 4 a 16 dígitos y solo puede contener letras</p>
        ...
        <div class="formulario__grupo" id="grupo__fechaNacimientoUsuario">
            ...
            <div class="formulario__grupo-input">
                <input type="date" class="formulario__input" name="fechaNacimientoUsuario" id="fechaNacimientoUsuario" value="<?php echo $usuario->getFechaNacimiento(); ?>">
                <i class="formulario__validacion-estado fas fa-times-circle"></i>
            </div>
            <br>
    ...
    <div id="parte3" style="display:none;">
        ...
        <div class="formulario__grupo" id="grupo__sexoUsuario">
            ...
            <div class="formulario__grupo-input">
                <select name="sexoUsuario" id="sexoUsuario" class="formulario__input">
                    ...
                    <?php foreach ($listadoSexo as $sexo): ?>
                        ...
                        if ($sexo->getIdSexo() == $usuario->getIdSexo()) {
                            $selected = "SELECTED";}
            ...
            <div class="formulario__grupo" id="grupo__usernameUsuario">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="usernameUsuario" id="usernameUsuario" value="<?php echo $usuario->getUsername(); ?>">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__passwordUsuario">
                ...
                <div class="formulario__grupo-input">
                    <input type="password" class="formulario__input" name="passwordUsuario" id="passwordUsuario" value="<?php echo $usuario->getPassword(); ?>">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
        ...
        <div id="parte4" style="display:none;">
            ...
            <table class="styled-table" style="font-size: 0.9rem;">
                ...
                <tbody>
                    <td><output id="list"><img class="thumb" src="/programacion_3/boutique/modulos/miPerfil/<?php echo $usuario->getImagen();  ?>"></output></td>
            ...
            <div class="formulario__grupo formulario__grupo-btn-enviar">
                ...
                <p class="formulario__mensaje-exito" id="formulario__mensaje-exito"><i class="fas fa-check-circle"></i><b>Excelente:</b> Formulario cargado correctamente!</p>
