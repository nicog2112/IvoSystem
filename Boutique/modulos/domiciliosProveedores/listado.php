...
$listadoDomicilios = DomicilioProveedor::obtenerPorIdProveedor($idProveedor,$filtroEstado);
        ...
        <th>Pais</th> -->
                ...
                <tbody>
                    <?php foreach  ($listadoDomicilios as $domicilio): ?>
                        <tr class="active-row">
                            <td><?php echo $domicilio->getIdProveedorDomicilio(); ?></td>
            ...
            <td><?php echo $domicilio->barrio->localidad->provincia->pais->getDescripcion(); ?></td> -->
                            ...
                            <td> <a href="../domiciliosProveedores/detalles.php?id_proveedor=<?php echo $idProveedor; ?>&id_domicilio=<?php echo $domicilio->getIdProveedorDomicilio(); ?>"><i class="botonGeneral fas fa-plus"></i> </a></td>
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $domicilio->getIdProveedorDomicilio(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $domicilio->getIdProveedorDomicilio(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
