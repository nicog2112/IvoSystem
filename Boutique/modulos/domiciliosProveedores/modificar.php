...
$id_proveedor_domicilio = $_GET['id'];
...
$domicilio = ProveedorDomicilio::obtenerPorId($id_proveedor_domicilio);
...
<form method="POST" action="procesar_modificacion.php"  enctype="multipart/form-data" class="form__reg" name="formulario" id="formularioModificar">
    ...
    <div id="parte1Modificar" style="display:block;">
         <input type="hidden" name="idProveedor" value="<?php echo $proveedor; ?>" >
          <input type="hidden" name="idProveedorDomicilio" value="<?php echo $id_proveedor_domicilio; ?>" >
    ...
    <div id="parte3Modificar" style="display:none;">
        ...
        <div class="formulario__grupo" id="grupo__casaModificar">
            <label for="casaModificar" class="formulario__label">Casa</label>
            <div class="formulario__grupo-input">
            ...
            <div class="formulario__grupo" id="grupo__torreModificar">
                <label for="torreModificar" class="formulario__label">Torre</label>
                <div class="formulario__grupo-input">
