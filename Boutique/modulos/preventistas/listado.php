...
$lista = Preventista::obtenerTodos($id_proveedor,$filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    switch ($_GET["error"]) {
          ...
          case 'select':
        $mensaje = "<div class='error'>"."Debe seleccionar una opcion de la lista de Personas"."</div>";
        break;
...
<script src="/programacion_3/boutique/js/select2.min.js"></script>
    ...
    <title>Preventistas de <?php echo $proveedor->getNombreProveedor(); ?></title>
</head>
<body>
    <!--========== HEADER ==========-->
    <header class="header">
        <div class="header__container">
            ...
            <div class="nombreModulo">
                ...
                <span id="modulo">preventistas</span>
                 <span><?php echo $proveedor->getNombreProveedor(); ?></span>
            </div>
...
<main>
    <section>
        ...
        <div id="containerNuevo">
            <button class="botonAñadir" id="abrir" value="<?php echo $id_proveedor; ?>" onclick="abrirModal(this.id,this.value);" ><i class="fas fa-plus"></i> Añadir </button>
        </div>
        <br>
                ...
                <tbody>
                    <?php foreach  ($lista as $preventista): ?>
                        <tr class="active-row">
                            ...
                            <td><?php echo $preventista->sexo->getDescripcion(); ?></td>
                            <?php
                            $estado = $preventista->getEstadoPreventista();
                            $clase="";
                            if ($estado == 1){
                                $estado = "Activo";
                                $clase= "estadoActivo";
                            ...
                            <td>
                                <a href="../domicilios/listado.php?id=<?php echo $preventista->getIdPreventista(); ?>&modulo=preventistas&id_persona=<?php echo $preventista->getIdPersona(); ?>"> <i class="botonGeneral fas fa-house-user"></i> </a>
                            </td>
                            <td>
                                <a href="../contactos/listado.php?id=<?php echo $preventista->getIdPreventista(); ?>&modulo=preventistas&id_persona=<?php echo $preventista->getIdPersona(); ?>"><i class="botonGeneral fas fa-phone-alt"></i></a>
                            </td>
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $preventista->getIdPreventista(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $preventista->getIdPreventista(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
            ...
            <div class="flex" id="flex">
                <div class="contenido-modal">
                    <div class="modal-header flex">
                        <h2>Añadir Nuevo Preventista</h2>
