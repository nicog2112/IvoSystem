...
$lista = TiposImpositivos::obtenerTodos($filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    switch ($_GET["error"]) {
     ...
     case 'descripcionAñadir':
        $mensaje = "<div class='error'>"."La descripcion  solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;

  

    case 'descripcionModificar':
        $mensaje1 = "<div class='error'>"."La descripcion solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;
    case 'valorAñadir':
        $mensaje = "<div class='error'>"."El valor solo puede contener numeros positivos"."</div>";
        break;


    case 'valorModificar':
        $mensaje1 = "<div class='error'>"."El valor solo puede contener numeros positivos"."</div>";
        break;
...
<html lang="en">
    <head>
        ...
        <!-- Validaciones JS -->
        <script src="../../js/formularioValorYdescripcion.js"></script>
        <script src="../../js/formularioValorYdescripcionModificar.js"></script>
    ...
    <body>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">tipo de impuestos</span>
                </div>
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="container">
                    <table id="tabla4" class="styled-table" >
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $TipoImpositivo): ?>
                                <tr class="active-row">


                                  <td><?php echo $TipoImpositivo->getIdTiposImpositivos(); ?></td>
									<td><?php echo $TipoImpositivo->getDescripcion(); ?></td>
									<td><?php echo $TipoImpositivo->getValorPorcentaje(); ?>%</td>
                                    <?php
                                    $estado = $TipoImpositivo->getEstado();
                                    $clase="";
                                    if ($estado == 1){
                                        $estado = "Activo";
                                        $clase= "estadoActivo";
									...
									<td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $TipoImpositivo->getIdTiposImpositivos(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $TipoImpositivo->getIdTiposImpositivos(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                    ...
                    <div class="flex" id="flex">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Añadir Nuevo Tipo de Impuesto</h2>
                ...
                <div id="miModal2" class="modal">
                    <div class="flex" id="flex2">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Modificar Tipo de Impuesto</h2>
                ...
                <div id="miModal4" class="modal">
                    <div class="flex" id="flex4">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Eliminar Tipo de Impuesto</h2>
