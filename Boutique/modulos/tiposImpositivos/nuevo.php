			...
			<div class="formulario__grupo" id="grupo__nombreNuevo">
				<label for="nombreNuevo" class="formulario__label">Nombre del tipo de Impuesto *</label>
			...
			<div class="formulario__grupo" id="grupo__valorPorcentajeNuevo">
				<label for="valorPorcentajeNuevo" class="formulario__label">Valor en Porcentaje del Impuesto *</label>
				<div class="formulario__grupo-input">
