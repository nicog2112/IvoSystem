    ...
    <header class="header">
        <div class="header__container">
            ...
            <div class="nombreModulo">
                ...
                <span id="modulo">domicilios</span>
                <span>de <?php 
            switch ($moduloMenu) {
                ...
                <tbody>
                    <?php foreach  ($listadoDomicilios as $domicilio): ?>
                        <tr class="active-row">
							...
							<td><?php echo $domicilio->getIdPersonaDomicilio(); ?></td>
                            ...
                            <td> <a href="../domicilios/detalleDomicilio.php?id=<?php echo $id; ?>&modulo=<?php echo $moduloMenu; ?>&id_persona=<?php echo $idPersona; ?>&id_persona_domicilio=<?php echo $domicilio->getIdPersonaDomicilio(); ?>"><i class="botonGeneral fas fa-plus"></i> </a></td>
                           
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $domicilio->getIdPersonaDomicilio(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $domicilio->getIdPersonaDomicilio(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
