...
<html lang="en">
    <head>
        ...
        <!-- Validaciones JS -->
        <script src="../../js/formularioActualizarPrecios.js"></script>
    ...
    <body onload="validarActualizacionPrecios();">
        <!--========== HEADER ==========-->
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    <span id="abmModulo">Formulario</span>
                    <span id="modulo">actualizacion de Precios</span>
                </div>
        ...
        <div class="form__top">
            ...
            <form method="POST" action="procesarActualizarPrecioPorcentaje.php" enctype="multipart/form-data" class="form__reg" name="formularioNuevo" id="formularioNuevo">
                <div>

                    <div class="formulario__grupo" id="grupo__cboMetodo" >
                        <label for="cboMetodo" class="formulario__label">Seleccione que Metodo desea usar para actualizar los precios:</label>
                        <div class="formulario__grupo-input">
                            <select required name="cboMetodo" id='cboMetodo' class="formulario__input" >
                ...
                <div id="categoria" hidden="hidden">
                    ...
                    <div class="formulario__grupo" id="grupo__categoriaAplicar" >
                        <label for="categoriaAplicar" class="formulario__label">Seleccione la categoria:</label>
                        <div class="formulario__grupo-input">
                            <select name="categoriaAplicar" id="categoriaAplicar"  class="formulario__input">
                ...
                <div id="temporada" hidden="hidden">
                    ...
                    <div class="formulario__grupo" id="grupo__temporadaAplicar" >
                        <label for="temporadaAplicar" class="formulario__label">Seleccione la temporada:</label>
                        <div class="formulario__grupo-input">
                            <select name="temporadaAplicar" id="temporadaAplicar"  class="formulario__input">
                                <option value="NULL">---Seleccionar---</option>
                ...
                <div id="marca" hidden="hidden">
                    <div class="formulario__grupo" id="grupo__marcaNuevo" >
                        <label for="marcaNuevo" class="formulario__label">Escriba la Marca:</label>
                        <div class="formulario__grupo-input">
                            <input name="marcaNuevo" id="marcaNuevo"  type="text"  class="formulario__input" placeholder="Marca">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                        <br>
                ...
                <div>
                    ...
                    <div class="formulario__grupo" id="grupo__cboMetodoActualizar" >
                        <label for="cboMetodoActualizar" class="formulario__label">Seleccione como desea actualizar los precios:</label>
                        <div class="formulario__grupo-input">
                            <select required name="cboMetodoActualizar" id='cboMetodoActualizar' class="formulario__input" >
                                <option value="">---Seleccionar---</option>
                ...
                <div id="porcentaje" hidden="hidden">
                    <div class="formulario__grupo" id="grupo__porcentajeAplicar" >
                        <label for="porcentajeAplicar" class="formulario__label">Escriba el porcentaje:</label>
                        <div class="formulario__grupo-input">
                            <input type="number" name="porcentajeAplicar" id="porcentajeAplicar" class="formulario__input">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                        <br>
                        <p class="formulario__input-error">Error</p>
                ...
                <div id="valorFijo" hidden="hidden">
                    <div class="formulario__grupo" id="grupo__valorFijoAplicar" >
                        <label for="valorFijoAplicar" class="formulario__label">Escriba el valor Fijo:</label>
                        <div class="formulario__grupo-input">
                            <input type="number" name="valorFijoAplicar" class="formulario__input">
                            <i class="formulario__validacion-estado fas fa-times-circle"></i>
                        </div>
                ...
                <div id="accion">
                    <div class="formulario__grupo" id="grupo__cuit" >
                        ...
                        <div class="formulario__grupo-input">
                            <input required type = "radio" name = "accion" value = "1" /> Aumentar
        ...
        <div class="formulario__grupo formulario__grupo-btn-enviar">
            ...
            <p class="formulario__mensaje-exito" id="formulario__mensaje-exito">Registros Actualizados Exitosamente!</p>
            <br>
        </div>
        <button type="cancel" name="Cancelar" class="botonCancelar"  onclick="window.location='/programacion_3/boutique/modulos/actualizarPrecios/listado.php';return false;">Cancelar</button>
