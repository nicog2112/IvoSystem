...
$lista = TipoFactura::obtenerTodos($filtroEstado);
...
if (isset($_GET["error"])) {
   ...
   case 'descripcionAñadir':
        $mensaje = "<div class='error'>"."La descripcion  solo puede contener letras los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;

  

    case 'descripcionModificar':
        $mensaje1 = "<div class='error'>"."La descripcion solo puede contener letras los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;
...
<html lang="en">
    <head>
        ...
        <!-- Validaciones JS -->
        <script src="../../js/formularioDescripcionFactura.js"></script>
        <script src="../../js/formularioDescripcionFacturaModificar.js"></script>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">tipo de factura</span>
                </div>
            ...
            <section id="contenedorPrincipal">
                            ...
                            <?php foreach  ($lista as $TipoFactura): ?>
                                <tr class="active-row">
                                  ...
                                  <td><?php echo $TipoFactura->getIdTipoFactura(); ?></td>
									...
									<td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $TipoFactura->getIdTipoFactura(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $TipoFactura->getIdTipoFactura(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                ...
                <div id="miModal2" class="modal">
                    <div class="flex" id="flex2">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Modificar Tipo de Factura</h2>
