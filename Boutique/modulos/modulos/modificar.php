		...
		<input type="hidden" name="txtIdModulo" value="<?php echo $id_modulo; ?>">
	     ...
	     <!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__nombre">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" value="<?php echo $Modulo->getDescripcion(); ?>" >
	     ...
	     <!-- Grupo: Directorio -->
			<div class="formulario__grupo" id="grupo__directorio">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="directorio" id="directorio" value="<?php echo $Modulo->getDirectorio(); ?>" >
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
