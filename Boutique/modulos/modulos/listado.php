...
if (isset($_GET["error"])) {
    ...
    case 'nombreModuloAñadir':
        $mensaje = "<div class='error'>"."El nombre del Modulo solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos unicamente en el medio y no puede estar vacio."."</div>";
        break;

    case 'directorioAñadir':
        $mensaje = "<div class='error'>"."El directorio del Modulo solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios no estan permitidos y no puede estar vacio."."</div>";
        break;

    case 'nombreModuloModificar':
        $mensaje1 = "<div class='error'>"."El nombre del Modulo solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos unicamente en el medio y no puede estar vacio."."</div>";
        break;

    case 'directorioModificar':
        $mensaje1 = "<div class='error'>"."El directorio del Modulo solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios no estan permitidos y no puede estar vacio."."</div>";
        break;
...
<html lang="en">
    <head>
        ...
        <script src="../../js/formularioModulosModificar.js"></script>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $modulo): ?>
                                <tr class="active-row">
                                    ...
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $modulo->getIdModulo(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $modulo->getIdModulo(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
