...
$lista = Temporada::obtenerTodos($filtroEstado);
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">temporadas</span>
                </div>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $temporada): ?>
                                <tr class="active-row">
                                    ...
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $temporada->getIdTemporada(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $temporada->getIdTemporada(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
