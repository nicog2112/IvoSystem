...
$lista = Cliente::obtenerTodos($filtroEstado);
                            ...
                            <td><?php echo $cliente->getApellido(); ?></td>
                             <td><?php echo $cliente->getDni(); ?></td>
                              <td><?php echo $cliente->getFechaAlta(); ?></td>
                                    ...
                                    <td>
                                        <a href="../domicilios/listado.php?id=<?php echo $cliente->getIdCliente(); ?>&modulo=clientes&id_persona=<?php echo $cliente->getIdPersona(); ?>"> <i class="botonGeneral fas fa-house-user"></i> </a>
                                    </td>
                                    <td>
                                        <a href="../contactos/listado.php?id=<?php echo $cliente->getIdCliente(); ?>&modulo=clientes&id_persona=<?php echo $cliente->getIdPersona(); ?>"><i class="botonGeneral fas fa-phone-alt"></i></a>
                                    
                                    </td>
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $cliente->getIdCliente(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $cliente->getIdCliente(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
