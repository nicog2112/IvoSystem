...
$lista = Empleado::obtenerTodos($filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    case 'nombrePersonaModificar':
        $mensaje1 = "<div class='error'>"."El nombre de la Persona solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos unicamente en el medio y no puede estar vacio."."</div>";
        break;

    case 'apellidoPersonaModificar':
        $mensaje1 = "<div class='error'>"."El apellido de la persona solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos unicamente en el medio y no puede estar vacio."."</div>";
        break;
    case 'dniPersonaModificar':
        $mensaje1 = "<div class='error'>"."El DNI de la persona tiene que ser de 8 a 11 dígitos y solo puede contener numeros."."</div>";
        break;
    case 'nacionalidadPersonaModificar':
        $mensaje1 = "<div class='error'>"."La nacionalidad de la persona solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos unicamente en el medio y no puede estar vacio."."</div>";
        break;
     case 'fechaNacimientoNuevo':
        $mensaje = "<div class='error'>"."La fecha de nacimiento debe ser menor a la fecha actual."."</div>";
        break;
    case 'fechaNacimientoModificar':
        $mensaje1 = "<div class='error'>"."La fecha de nacimiento debe ser menor a la fecha actual."."</div>";
        break;
...
<script src="/programacion_3/boutique/js/select2.min.js"></script>
        ...
        <!-- Validaciones JS -->
        <script src="../../js/formularioPreventista.js"></script>
    <script src="../../js/formularioPreventistaModificar.js"></script>
                        ...
                        <tbody>
                            ...
                            <td><?php echo $empleado->getApellido(); ?></td>
                             ...
                             <td><?php echo $empleado->getNumeroLegajo(); ?></td>
                                    ...
                                    <?php
                                    $estado = $empleado->getEstadoEmpleado();
                                    $clase="";
                                    if ($estado == 1){
                                        $estado = "Activo";
                                        $clase= "estadoActivo";
                                    ...
                                    <td> <a href="../persona/detalle.php?id_persona=<?php echo $empleado->getIdPersona();?>"><i class="botonGeneral fas fa-plus"></i> </a></td>
                                    <td>
                                        <a href="../domicilios/listado.php?id=<?php echo $empleado->getIdEmpleado(); ?>&modulo=empleados&id_persona=<?php echo $empleado->getIdPersona(); ?>"> <i class="botonGeneral fas fa-house-user"></i> </a>
                                    </td>
                                    <td>
                                        <a href="../contactos/listado.php?id=<?php echo $empleado->getIdEmpleado(); ?>&modulo=empleados&id_persona=<?php echo $empleado->getIdPersona(); ?>"><i class="botonGeneral fas fa-phone-alt"></i></a>
                                    </td>
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $empleado->getIdEmpleado(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $empleado->getIdEmpleado(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
