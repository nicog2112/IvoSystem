...
$lista = ProductoTalle::obtenerPorIdProducto($idProducto, $filtroEstado);
...
<html lang="en">
    <head>
        ...
        <!-- Validaciones JS -->
        <script src="../../js/formularioProductoTalle.js"></script>
        <script src="../../js/formularioProductoTalleModificar.js"></script>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">producto talle</span>
                </div>
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="containerNuevo">
                    <button class="botonAñadir" id="abrir" onclick="abrirModal(this.id,this.value);" value="<?php echo $idProducto; ?>"><i class="fas fa-plus"></i> Añadir </button>
                </div>
                <br>
                ...
                <div id="container">
                    <table id="example" class="styled-table" >
                        ...
                        <tbody>
                            <?php foreach  ($lista as $productoTalle): ?>
                                <tr class="active-row">
                                        ...
                                        <?php
                                    $estado = $productoTalle->getEstado();
                                    $clase="";
                                    if ($estado == 1){
                                        $estado = "Activo";
                                        $clase= "estadoActivo";
                                    ...
                                    ?>
                                         ...
                                         <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $productoTalle->getIdProductoTalle(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                        <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $productoTalle->getIdProductoTalle(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                    ...
                    <div class="flex" id="flex">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Añadir Nuevo Talle y Stock</h2>
                ...
                <input type="hidden" name="idProductoModificar" id="idProductoModificar" value="<?php echo $idProducto; ?>">
