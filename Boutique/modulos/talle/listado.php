...
$lista = Talle::obtenerTodos($filtroEstado);
...
<html lang="en">
    <head>
        ...
        <script src="../../js/formularioTalleNuevo.js"></script>
        <script src="../../js/formularioTalleModificar.js"></script>
            ...
            <section id="contenedorPrincipal">
                ...
                <div id="container">
                    <table id="example" class="styled-table" >
                        ...
                        <tbody>
                            <?php foreach  ($lista as $talle): ?>
                                <tr class="active-row">


                                    <td id="idDeCategoria"><?php echo $talle->getIdTalle(); ?></td>
                            <td id="nombre <?php echo $talle->getIdTalle(); ?>"><?php echo $talle->getDescripcion(); ?></td>
                             <?php
                                    $estado = $talle->getEstado();
                                    $clase="";
                                    if ($estado == 1){
                                        $estado = "Activo";
                                        $clase= "estadoActivo";
                                    ...
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $talle->getIdTalle(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $talle->getIdTalle(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
