...
$lista = TipoContacto::obtenerTodos($filtroEstado);
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">tipo de contacto</span>
                </div>
            ...
            <section id="contenedorPrincipal">
                            ...
                            <?php foreach  ($lista as $contacto): ?>
                                <tr class="active-row">
                                   ...
                                   <td><?php echo $contacto->getIdTipoContacto(); ?></td>
                                    ...
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $contacto->getIdTipoContacto(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $contacto->getIdTipoContacto(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                    ...
                    <div class="flex" id="flex">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Añadir Nuevo Tipo de Contacto</h2>
                ...
                <div id="miModal2" class="modal">
                    <div class="flex" id="flex2">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Modificar Tipo de Contacto</h2>
                ...
                <div id="miModal4" class="modal">
                    <div class="flex" id="flex4">
                        <div class="contenido-modal">
                            <div class="modal-header flex">
                                <h2>Eliminar Tipo de Contacto</h2>
