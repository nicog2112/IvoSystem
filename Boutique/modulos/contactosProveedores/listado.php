...
$listadoContactos = ContactoProveedor::obtenerPorIdProveedor($idProveedor,$filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    // Validacion Mi Perfil lado del Servidor
...
<head>
   ...
   <script src="../../js/selectAnidados.js"></script>
    ...
    <title>Listado contactos de <?php echo $proveedor->getNombreProveedor();?></title>
</head>
<body>
    <!--========== HEADER ==========-->
    <header class="header">
        <div class="header__container">
            ...
            <div class="nombreModulo">
                ...
                <span id="modulo">contactosProveedores</span>
...
<main>
    <section>
        ...
        <div id="containerNuevo">
            <button class="botonAñadir" id="abrir" value="<?php echo $idProveedor; ?>" onclick="abrirModal(this.id,this.value);" ><i class="fas fa-plus"></i> Añadir </button>
        </div>
        <br>
                ...
                <tbody>
                    <?php foreach  ($listadoContactos as $contacto): ?>
                        <tr class="active-row">
                            ...
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $contacto->getIdProveedorContacto(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $contacto->getIdProveedorContacto(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
