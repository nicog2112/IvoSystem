...
<table id="tableID" class="styled-table">
    ...
    <?php foreach  ($lista as $Perfil): ?>
        ...
        <tr>
            ...
            <td><a href="listadoModulos.php?id_perfil=<?php echo $Perfil->getIdPerfil(); ?>"><i class="botonActualizar fa fa-bezier-curve"></i></a></td>
            <td><button style="outline:none;border:0;" type="button" id="abrir2" value="<?php echo $Perfil->getIdPerfil(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>
    
            <td><a href="eliminar.php?id_perfil=<?php echo $Perfil->getIdPerfil(); ?>" class="btn-bootstrap2"><i class="botonEliminar fas fa-trash"></i></a></td>
    ...
    <?php endforeach ?>
            	...
            	<div class="flex" id="flex">
            		<div class="contenido-modal">
            			...
            			<div class="modal-body">
            				<?php require_once "../../../modulos/configuracion/perfiles/nuevo.php";?>
		...
		<div class="flex" id="flex2">
			<div class="contenido-modal">
				...
				<div class="modal-body">
							<?php require_once "../../../modulos/configuracion/perfiles/modificar.php";?>
				</div>
