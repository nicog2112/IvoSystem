...
$lista = Proveedor::obtenerTodos($filtroEstado);
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">proveedores</span>
                </div>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $Proveedor): ?>
                                <tr class="active-row">
                                    ...
                                    <td>
                                        <a href="../domiciliosProveedores/listado.php?id_proveedor=<?php echo $Proveedor->getIdProveedor(); ?>&modulo=proveedor" > <i class="botonGeneral fas fa-house-user"></i> </a>
                                    </td>
                                    <td>
                                        <a href="../contactosProveedores/listado.php?id_proveedor=<?php echo $Proveedor->getIdProveedor(); ?>"><i class="botonGeneral fas fa-phone-alt"></i></a>
                                    </td>
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $Proveedor->getIdProveedor(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $Proveedor->getIdProveedor(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
