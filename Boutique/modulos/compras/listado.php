...
$lista = Compra::obtenerTodos($filtroEstado);
...
<main>
 ...
 <section id="contenedorPrincipal">
                ...
                <div id="containerNuevo">
                    <a href="./comprar.php" class="botonAñadir" id="abrir"><i class="fas fa-plus"></i> Añadir </a>
                     <?php foreach ($listadoModulos as $modulo5): ?>
                    <?php  if ($modulo5->getNivel() == 5) {
  
                             ?>
                     <a href="/programacion_3/boutique/modulos/reportes/reporteCompras.php" class="botonAñadir"  ><i class="fas fa-chart-line"></i> Reportes </a>
                      <?php break; } ?>
                        ...
                        <?php foreach($lista as $compra){ ?>
                            <tr class="active-row">
                                ...
                                <td>$<?php echo $compra->getTotal(); ?></td>
                                 ...
                                 <td><a href="listadoDetalleCompra.php?id=<?php echo $compra->getIdCompra(); ?>"> <i class="botonGeneral fas fa-search-plus"></i> </a>
                                </td>
                                <td>
                                    <?php if($compra->getIdEstadoPedido() == 1){ ?>
                                    <a href="eliminarVenta.php?id_pedido_proveedor=<?php echo $compra->getIdCompra(); ?>"><i class="botonEliminar fas fa-window-close"></i></a></td>
                                    <?php } ?>
                                    <?php if($compra->getIdEstadoPedido() == 2) { ?>
                ...
                <table style="margin: auto; width: 100%;text-align: center;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="100px">Mostrar detalle de Compra</td>
