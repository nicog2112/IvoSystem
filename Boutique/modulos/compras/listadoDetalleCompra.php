...
$id_compra= $_GET["id"];
$lista = Compra::obtenerPorIdCompra($id_compra);
$listaDetallesCompras = DetalleCompra::obtenerPorIdCompra($id_compra);
    ...
    <body>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">detalles de compra</span>
                </div>
        ...
        <main>
            <section id="contenedorPrincipal" >
                    ...
                    <br><br>
                    <h3 style="text-align:center;">Proveedor</h3>
                ...
                <div id="container">
                    ...
                    <table class="styled-table">
                        ...
                        <tbody id="detalle_productos">
                            <?php foreach($lista as $compra){ ?>
                                <?php foreach($listaDetallesCompras as $detalleCompra){ ?>
                                    <tr>
                                        <td class="textcenter"><?php echo $detalleCompra->getCantidad(); ?></td>
                                        <td><?php echo $detalleCompra->productoTalle->producto->getDescripcion(); ?></td>
                                 
                                        <td class="textright">$<?php echo $detalleCompra->getPrecio(); ?></td>
                                        <?php 

                                        $precio_total="";
                                        $cantidad= $detalleCompra->getCantidad();
                                        $precio_venta= $detalleCompra->getPrecio();
                            ...
                            <tfoot id="detalle_totales">
                                ...
                                <tr>
                                    ...
                                    <td class="textright"><span>$<?php $subtotal=$compra->getTotal(); echo $subtotal;  ?></span></td>
                                </tr>
                            <?php }  ?>
                            <?php 
                            $totalSumaImpuestos = 0;
                            
                            /*$listaFacturaImpuestos = FacturaImpuestos::obtenerTodos();
