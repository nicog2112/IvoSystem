...
$lista = TipoPago::obtenerTodos($filtroEstado);
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">tipo de pago</span>
                </div>
                            ...
                            <?php foreach  ($lista as $TipoPago): ?>
                                <tr class="active-row">
                                  ...
                                  <td><?php echo $TipoPago->getIdTipoPago(); ?></td>
									...
									<td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $TipoPago->getIdTipoPago(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $TipoPago->getIdTipoPago(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
