	...
	<form method="POST" action="procesar_modificacion.php"  class="form__reg" name="formularioModificar" id="formularioModificar">
		...
		<input type="hidden" name="txtIdTipoPago" value="<?php echo $id_tipo_pago; ?>">
			...
			<div class="formulario__grupo" id="grupo__nombre">
				<label for="nombre" class="formulario__label">Nombre del tipo de Pago *</label>
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="nombre" id="nombre" value="<?php echo $tipoPago->getDescripcion(); ?>">
			...
			<div class="formulario__grupo" id="grupo__valorPorcentaje">
				<label for="valorPorcentaje" class="formulario__label">Porcentaje de Descuento *</label>
				<div class="formulario__grupo-input">
					<input type="number" class="formulario__input" name="valorPorcentaje" id="valorPorcentaje" value="<?php echo $tipoPago->getValorPorcentaje(); ?>">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
				<br>
