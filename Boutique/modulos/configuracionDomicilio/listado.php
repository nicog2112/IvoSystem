...
$lista = pais::obtenerTodos($filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    switch ($_GET["error"]) {
     ...
     case 'nombrePaisAñadir':
        $mensaje = "<div class='error'>"."El nombre del Pais solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;

  

    case 'nombrePaisModificar':
        $mensaje1 = "<div class='error'>"."El nombre del Pais solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;
                        ...
                        <tbody>
                            <?php foreach  ($lista as $pais): ?>
                                <tr class="active-row">
                                    ...
                                    <td><a href="/programacion_3/boutique/modulos/configuracionDomicilio/listadoProvincia.php?id_pais=<?php echo $pais->getIdPais(); ?>"><i class="botonGeneral fas fa-map-marker-alt"></i></a></td>
                                    
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $pais->getIdPais(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $pais->getIdPais(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
