...
$lista = provincia::obtenerPorIdPais($id_pais,$filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    case 'nombreProvinciaAñadir':
        $mensaje = "<div class='error'>"."El nombre de la Provincia solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;

  

    case 'nombreProvinciaModificar':
        $mensaje1 = "<div class='error'>"."El nombre de la Provincia solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="containerNuevo">
                    <button class="botonAñadir" id="abrir" onclick="abrirModal(this.id,this.value);" value="<?php echo $id_pais; ?>" ><i class="fas fa-plus"></i> Añadir </button>
                </div>
                <br>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $provincia): ?>
                                <tr class="active-row">
                                    ...
                                    <td><a href="/programacion_3/boutique/modulos/configuracionDomicilio/listadoLocalidad.php?id_provincia=<?php echo $provincia->getIdProvincia(); ?>"><i class="botonGeneral fas fa-map-marker-alt"></i></a></td>
                                    
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $provincia->getIdProvincia(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $provincia->getIdProvincia(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                ...
                <input type="hidden" name="idPaises" id="idPaisModificar" value="<?php echo $id_pais; ?>">
