...
$lista = Localidad::obtenerPorIdProvincia($id_provincia,$filtroEstado);
...
if (isset($_GET["error"])) {
    ...
    case 'nombreLocalidadAñadir':
        $mensaje = "<div class='error'>"."El nombre de la Localidad solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;

  

    case 'nombreLocalidadModificar':
        $mensaje1 = "<div class='error'>"."El nombre de la Localidad solo puede contener letras, se debe escribir minimo 3 caracteres, los espacios estan permitidos en el medio y no puede estar vacio."."</div>";
        break;
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="containerNuevo">
                    <button class="botonAñadir" id="abrir" onclick="abrirModal(this.id,this.value);" value="<?php echo $id_provincia; ?>" ><i class="fas fa-plus"></i> Añadir </button>
                </div>
                <br>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $localidad): ?>
                                <tr class="active-row">
                                    ...
                                    <td><a href="/programacion_3/boutique/modulos/configuracionDomicilio/listadoBarrio.php?id_localidad=<?php echo $localidad->getIdLocalidad(); ?>"><i class="botonGeneral fas fa-map-marker-alt"></i></a></td>
                                    
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $localidad->getIdLocalidad(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $localidad->getIdLocalidad(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
                ...
                <input type="hidden" name="idPaises" id="idProvinciaModificar" value="<?php echo $id_provincia; ?>">
