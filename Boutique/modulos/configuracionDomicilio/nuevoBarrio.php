...
?>
			...
			<form method="POST" action="procesar_altaBarrio.php" class="form__reg" name="formularioNuevo" id="formularioNuevo">
				
			<input type="hidden" name="txtIdLocalidad" value="<?php echo $id_localidad; ?>">

			<!-- Grupo: Nombre -->
			<div class="formulario__grupo" id="grupo__nombreNuevo">
				<label for="nombreNuevo" class="formulario__label">Nombre del Barrio *</label>
			...
			<button type="cancel" name="Cancelar" class="botonCancelar"  onclick="window.location='/programacion_3/boutique/modulos/configuracionDomicilio/listadoBarrio.php?id_localidad=<?php echo $id_localidad; ?>';return false;">Cancelar</button>
