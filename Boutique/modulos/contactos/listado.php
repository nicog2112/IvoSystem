...
$listadoContactos = Contacto::obtenerPorIdPersona($idPersona,$filtroEstado);
...
switch ($moduloMenu) {
  ...
  case 'preventistas':
        $id= $_GET['id'];
        $preventista = Preventista::obtenerPorId($id);
        $persona = Preventista::obtenerPorIdPersona($idPersona);
        break;
...
if (isset($_GET["error"])) {
    ...
    switch ($_GET["error"]) {
     ...
     case 'tipoContactoNuevo':
        $mensaje = "<div class='error'>"."Seleccione un tipo de contacto"."</div>";
        break;

        case 'valorNuevo':
        $mensaje = "<div class='error'>"."El valor no puede estar vacio."."</div>";
        break;

         case 'tipoContactoModificar':
        $mensaje1 = "<div class='error'>"."Seleccione un tipo de contacto"."</div>";
        break;

        case 'valorModificar':
        $mensaje1 = "<div class='error'>"."El valor no puede estar vacio."."</div>";
        break;
...
<head>
    ...
    <script src="../../js/formularioContactoModificar.js"></script>
   ...
   <script src="../../js/selectAnidados.js"></script>
    ...
    <title>Listado Contactos de  <?php 
            switch ($moduloMenu) {

                case 'empleados':

                    echo $empleado->getNombre(); echo " "; echo $empleado->getApellido(); 
                    break;

                case 'preventistas':
                    echo $preventista->getNombre(); echo " "; echo $preventista->getApellido();  
                    break;

                case 'clientes':
                    echo $cliente->getNombre(); echo " "; echo $cliente->getApellido();  
                    break;
...
<main>
    <section>
        ...
        <div id="containerNuevo">
            <button class="botonAñadir" id="abrir" value="<?php echo $idPersona; ?>" onclick="abrirModal(this.id,this.value);" ><i class="fas fa-plus"></i> Añadir </button>
        </div>
        <br>
        <form method="GET" class="formularioEstado">
            ...
            <input type="hidden" name="id_persona" value="<?php echo $idPersona; ?>">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <input type="hidden" name="modulo" value="<?php echo $moduloMenu; ?>">
                ...
                <tbody>
                    <?php foreach  ($listadoContactos as $contacto): ?>
                        <tr class="active-row">
                            ...
                            <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $contacto->getIdPersonaContacto(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                            <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $contacto->getIdPersonaContacto(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
...
<input type="hidden" id="idPersonaModificar" value="<?php echo $idPersona; ?>">
<input type="hidden" id="idModuloMenu" value="<?php echo $moduloMenu; ?>">
<input type="hidden" id="idMenu" value="<?php echo $id; ?>">
