...
$año= strftime("%Y");;
$lista = Venta::obtenerTodosPedidos($Empleado,$Cliente, $fechaDesde,$fechaHasta );
$ventasDelAño = Venta::obtenerPedidosPorMeses($año);
$ventasDelMes = Venta::obtenerPedidosPorMesActual();
$ventasDeLaSemana = Venta::obtenerPedidosPorSemanaActual();
$ventasDelDia = Venta::obtenerPedidosPorDiaActual();
...
foreach($ventasDelDia as $ventaDelDia){
    ...
    $dataPoints4[]= array("label"=>"Pagina Web", "y"=>$ventaDelDia->getTotal());
}
  ...
  if( $("#chartContainer4").css('display') === 'block')
    ...
    <body>
        ...
        <div class="contenedorGraficoPrincipal" id="graficoAnual" style="display: block;">
                ...
                <h4 id="tituloAnual">Grafico de Pedidos Anual</h4>
                <div id="chartContainer"></div>
                <h4 id="tituloMensual" style="display: none">Grafico de Pedidos Mensual</h4>
                <div id="chartContainer2"></div>
                <h4 id="tituloSemanal" style="display: none">Grafico de Pedidos Semanal</h4>
                <div id="chartContainer3"></div> 
                <h4 id="tituloDia" style="display: none">Grafico de Pedidos del Dia</h4>
