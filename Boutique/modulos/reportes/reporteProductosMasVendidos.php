...
$lista = DetalleVenta::obtenerTodosMasVentas();
...
<html lang="en">
    <head>
        <title>Reporte productos con mas ventas</title>
        <meta charset="UTF-8">
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    <span id="abmModulo">Reporte</span>
                    <span id="modulo">productos con mas ventas</span>
                </div>
            ...
            <section id="contenedorPrincipal">
                ...
                <div id="container">
                    <table id="tabla6" class="styled-table" >
                        ...
                        <tbody>
                            <?php foreach  ($lista as $detalleVenta): ?>
                                <tr class="active-row">
                                    ...
                                    <td><?php echo $detalleVenta->productoTalle->producto->getNombreProducto(); ?></td>
                                    <td><?php echo $detalleVenta->productoTalle->producto->getMarca(); ?></td>
                            
                                    <td><?php echo $detalleVenta->productoTalle->producto->categoria->getNombre(); ?></td>
                                    <td><?php echo $detalleVenta->productoTalle->producto->temporada->getNombre(); ?></td>
