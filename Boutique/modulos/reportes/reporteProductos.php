...
$lista = ProductoTalle::obtenerTodosProductos($filtroEstado);
    ...
    <body>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <div class="nombreModulo">
                    ...
                    <span id="modulo">productos con baja Existencia</span>
                </div>
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="container">
                    <table id="tabla9" class="styled-table" >
                        <thead>
                            <tr>
                                <th>ID </th>
                                <th>IMAGEN</th>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $Producto): ?>
                                <tr class="active-row">
                                    ...
                                    <td><?php echo $Producto->producto->getNombreProducto(); ?></td>
                                    <td><?php echo $Producto->producto->getMarca(); ?></td>
                                   <td><?php echo $Producto->talle->getDescripcion(); ?></td>
                                   <td><?php echo $Producto->getCantidadMinima(); ?></td>
                                    <td><?php echo $Producto->getCantidadDisponible(); ?></td>
