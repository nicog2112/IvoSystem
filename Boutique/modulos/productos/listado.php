...
$lista = Producto::obtenerTodos($filtroEstado);
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="containerNuevo">
                    ...
                    <?php  if ($modulo5->getNivel() == 5) {
  
                             ?>

                    <a href="/programacion_3/boutique/modulos/reportes/reporteProductos.php" class="botonAñadir"  ><i class="fas fa-chart-line"></i> Reportes baja existencia</a>
                    <a href="/programacion_3/boutique/modulos/reportes/reporteProductosMasVendidos.php" class="botonAñadir"  ><i class="fas fa-chart-line"></i> Reportes Mas Vendidos</a>
                         <?php break; } ?>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $Producto): ?>
                                <tr class="active-row">
                                    ...
                                    <td> <a href="../productos/detalle.php?id_producto=<?php echo $Producto->getIdProducto();?>"><i class="botonGeneral fas fa-plus"></i> </a></td>

                                    <td><a href="/programacion_3/boutique/modulos/productoTalle/listado.php?id_producto=<?php echo $Producto->getIdProducto(); ?>" ><i  class="botonGeneral fas fa-box-open"></i></a></td>



                                    <td><button style="outline:none;border:0;" type="button" id="abrir2" value="<?php echo $Producto->getIdProducto(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>
