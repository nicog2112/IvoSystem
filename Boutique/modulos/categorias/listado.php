...
$lista = Categoria::obtenerTodos($filtroEstado);
    ...
    <body>
        ...
        <main>
            <section id="contenedorPrincipal">
                ...
                <div id="container">
                    <table id="tabla2" class="styled-table" >
                        <thead>
                            <tr>
                                <th>ID CATEGORIA</th>
                                <th>NOMBRE</th>
                        ...
                        <tbody>
                            <?php foreach  ($lista as $Categoria): ?>
                                <tr class="active-row">
                                    ...
                                    <td id="idDeCategoria"><?php echo $Categoria->getIdCategoria(); ?></td>
                            <td id="nombre <?php echo $Categoria->getIdCategoria(); ?>"><?php echo $Categoria->getNombre(); ?></td>
                             <?php
                                    ...
                                    <td><button class="btnActualizar" type="button" id="abrir2" value="<?php echo $Categoria->getIdCategoria(); ?>"  onclick="abrirModal(this.id,this.value);"><i class="botonActualizar fas fa-edit"></i></button></td>


                                    <td><button class="btnActualizar" id="abrir4" onclick="abrirModal(this.id,this.value);" value="<?php echo $Categoria->getIdCategoria(); ?>"><i class="botonEliminar fas fa-trash"></i></button></td>
